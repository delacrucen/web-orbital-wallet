  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="shrink-0 whitespace-nowrap rounded-full bg-gradient-to-b from-[#ff6b6b] to-[#e03e3e] px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-red-900/30 transition hover:brightness-110">
          Descargar App
        </button>
      </nav>
    </header>
